            ...
            <div class="card-body p-lg-20">
                ...
                <div class="d-flex flex-center mb-5 mb-lg-15">
                    ...
                    <ul class="nav border-transparent flex-center fs-5 fw-bold">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6" href="#"
                                data-bs-toggle="tab" data-bs-target="#kt_landing_projects_development">Development</a>
                        </li>
                    </ul>
                    <!--end::Tabs-->
                </div>
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a class="d-block card-rounded overlay h-lg-100" data-fslightbox="lightbox-projects"
                                    ...
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                        style="background-image:url('{{ asset('media/stock/600x600/img-23.jpg') }}')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                            ...
                            <div class="col-lg-6">
                                ...
                                <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                        style="background-image:url('{{ asset('media/stock/600x600/img-20.jpg') }}')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        <i class="ki-duotone ki-eye fs-3x text-white">
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a class="d-block card-rounded overlay h-lg-100" data-fslightbox="lightbox-projects"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                        style="background-image:url('{{ asset('media/stock/600x600/img-11.jpg') }}')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        <i class="ki-duotone ki-eye fs-3x text-white">
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                        style="background-image:url('{{ asset('media/stock/600x600/img-15.jpg') }}')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        <i class="ki-duotone ki-eye fs-3x text-white">
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                        style="background-image:url('{{ asset('media/stock/600x600/img-14.jpg') }}')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        <i class="ki-duotone ki-eye fs-3x text-white">
